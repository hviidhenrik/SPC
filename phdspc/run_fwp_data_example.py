...
df_phase2 = pd.read_csv(path + "data_pump_30_phase2_2020-2.csv", index_col="timelocal")

# df_phase1 = df_phase1.sample(frac=0.05).sort_index()
# df_phase2 = df_phase2.sample(frac=0.05).sort_index()
...
chart = PCAModelChart(alpha=0.01).fit(df_phase1, n_components_to_retain=None, PC_variance_explained_min=0.9, verbose=True)
